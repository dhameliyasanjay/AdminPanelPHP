...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO product_brand (brand,is_active,is_deleted)
		VALUES ('{$brand}','{$is_active}','{$is_deleted}')";
                ...
                <div class="tab-pane" id="tab_2">
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" id="brand" method="post" class="form-horizontal">
                                <div class="form-body">
                                    <h3 class="form-section">Product Brand</h3>
                                    <div class="row">
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-md-3">Product Brand Deleted :</label>
                                                <div class="col-md-9 margin-top-10">
                                                    <label class="margin-right-10">
