                    ...
                    <div class="portlet light portlet-fit bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-dark bold uppercase">Product Unit</span>
                            </div>
                            <div class="actions">
                                <div class="btn-group">
                                    <a class="btn dark btn-outline btn-circle btn-sm" href="product_unit.php">
                                        Product Unit create
                                    </a>
                                </div>
                            </div>
                                        ...
                                        while ($row = mysqli_fetch_array($result)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="product_unit_update.php?id=<?php echo $row['id']; ?>"
                                                       class="margin-right-10" title="Update Record"><span
                                                                class="fa fa-pencil"></span></a>
                                                    <a href="product_unit_deleted.php?id=<?php echo $row['id']; ?>"
