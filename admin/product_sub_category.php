...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO product_sub_category (category_id, sub_category_name, is_active, is_deleted)
		VALUES ('{$category_id}','{$sub_category_name}','{$is_active}','{$is_deleted}')";
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" name="sub_category_name" placeholder="Product Sub Categoty Name ">
                                                    <span class="help-block"> </span>
                                                </div>
                                            </div>
                                        </div>
